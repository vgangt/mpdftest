		...
		switch ($tag) {
			...
			case 'MAIN':
				...
				if (isset($properties['FLOAT']) && strtoupper($properties['FLOAT']) == 'RIGHT' && !$this->mpdf->ColActive) {
					...
					$maxw = $container_w - $l_width - $r_width;
/*					
echo var_dump($setwidth) . "<br>";
echo var_dump($currblk['margin_left']) . "<br>";
echo var_dump($currblk['margin_right']) . "<br>";
echo var_dump($bdl) . "<br>";
echo var_dump($pdl) . "<br>";
echo $pdl.'<br>';
echo var_dump($bdr) . "<br>";
echo var_dump($pdr) . "<br>";
echo $pdr.'<br>';
echo var_dump($maxw) . "<br>";
echo '-------------------<br>';
*/
$pdl = (int)$pdl;
$pdr =(int)$pdr;
...
/*
 echo var_dump($currblk['inner_width'])."<br>";
echo var_dump($currblk['width'])."<br>";
echo var_dump($currblk['border_left']['w'])."<br>";
echo var_dump($currblk['padding_left'])."<br>";
echo var_dump($currblk['border_right']['w'])."<br>";
echo var_dump($currblk['padding_right']) . "<br>";
*/
$currblk['padding_right'] = (int)($currblk['padding_right']);
 $currblk['padding_left'] = (int)($currblk['padding_left']);
