...
//echo'fontkey-'.$this->fontkey; exit;
	   ...
	   ///print_r($this->GDEFdata[$this->fontkey]);
	...
	//print_r($this->GDEFdata[$this->fontkey]).'<br>'; 
			...
			//echo 'file_get_content_'.file_get_contents(_MPDF_TTFONTDATAPATH . $this->fontkey . '.GSUBGPOStables.dat', 'rb').'<br>';
			//echo 'ttfOTLdata-'.$this->ttfOTLdata; exit;
					if (!$this->ttfOTLdata) {
